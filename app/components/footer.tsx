        ...
        <footer className="bg-[#F5F5F5] pt-12 pb-8 px-4">
          ...
          <div className="w-2/3 block sm:flex text-sm mt-6 lg:mt-0">
              <ul className="text-black list-none p-0 font-thin flex flex-col text-left w-full">
                  ...
                  <li><a href="/" className="inline-block py-2 px-3 text-black font-normal">Features</a></li>
                  <li><a href="/" className="inline-block py-2 px-3 text-black font-normal">Integrations</a></li>
                  <li><a href="/" className="inline-block py-2 px-3 text-black font-normal">Pricing</a></li>
                  <li><a href="/" className="inline-block py-2 px-3 text-black font-normal">FAQ</a></li>
              </ul>
              <ul className="text-black list-none p-0 font-thin flex flex-col text-left w-full">
                  <li className="inline-block py-2 px-3 text-black uppercase font-medium tracking-wide">Company</li>
                  <li><a href="/" className="inline-block py-2 px-3 text-black font-normal">Privacy</a>
                  </li>
                  <li><a href="/" className="inline-block py-2 px-3 text-black font-normal">Terms of Service</a></li>
              </ul>
              <ul className="text-black list-none p-0 font-thin flex flex-col text-left w-full">
                  <li className="inline-block py-2 px-3 text-black uppercase font-medium tracking-wide">Developers</li>
                  <li><a href="/" className="inline-block py-2 px-3 text-black font-normal">Developer API</a></li>
                  <li><a href="/" className="inline-block py-2 px-3 text-black font-normal">Documentation</a></li>
                  <li><a href="/" className="inline-block py-2 px-3 text-black font-normal">Guides</a></li>
                  
              </ul>
              
              <div className="text-black flex flex-col w-full">
                  <div className="inline-block py-2 px-3 text-black uppercase font-medium tracking-wide">Follow Us</div>
                  <div className="flex pl-4 justify-start mt-2">
                      <a className="flex items-center text-black mr-6 no-underline" href="/">
                      ...
                      <a className="flex items-center text-[text-black] mr-6 no-underline" href="/">
                          <svg viewBox="0 0 24 24" className="fill-current w-5 h-5" xmlns="http://www.w3.org/2000/svg">
